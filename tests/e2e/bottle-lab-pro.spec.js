...
test('public Bottle Lab demo is safe and does not request the Pro fixture', async ({ page }) => {
  const requests = [];
  ...
  expect(requests.some((url) => url.includes('bottle-items.sample.js'))).toBe(false);
